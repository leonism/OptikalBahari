...
**File:** `_includes/cloudinary/cloudinary-image-ratio.html`
...
{% endcapture %}
{% include cloudinary/cloudinary-image-ratio.html ratio="16x9" content=card_content %}
```
...
```liquid
{%
  include cloudinary/cloudinary-image-ratio.html
  ratio="16x9"
...
/>
{% endcapture %}
{% include cloudinary/cloudinary-image-ratio.html ratio="1x1" content=profile_content %}
```

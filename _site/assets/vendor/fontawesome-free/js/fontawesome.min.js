        ...
        a.found && n.found
          ? ((w = (b = q).children),
            ...
            (j = {
              ...
              children: [Et(G({ tag: S.tag, attributes: G({}, S.attributes, M.path) }, E))],
            }),
  ...
  function se(t) {
    ...
    return (
      ...
      o.prefix && 1 < i.length
        ...
        : o.prefix && 1 === i.length && (o.iconName = Vt(o.prefix, Dt(t.innerText))),
      o
    )
  }
  var le = function (t) {
    ...
    Ie =
      ...
      function (t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
          n = (t || {}).icon ? t : je(t || {}),
          a = e.mask
        return (a && (a = (a || {}).icon ? a : je(a || {})), Le(n, G({}, e, { mask: a })))
      }),
    Ye = {
      noAuto: function () {

...
<div class="card-deck mb-3">
    <div class="card shadow p-3 mb-5 rounded">
        {% include cloudinary/cloudinary-card-image.html src='assets/img/posts/trend-kacamata-2023/trend-kacamata-2023-01.webp' alt='lensa-progresif.webp' ratio='16x9' class='card-img-top' %}
        <div class="card-body">
            <h3 class="card-title">
...
<div class="card-deck mb-3">
    <div class="card shadow p-3 mb-5 rounded">
        {% include cloudinary/cloudinary-card-image.html src='assets/img/posts/trend-kacamata-2023/trend-kacamata-2023-02.webp' alt='lensa-progresif.webp' ratio='16x9' class='card-img-top' %}
        <div class="card-body">
            <h3 class="card-title">
